...
export function AboutContent() {
  ...
  const stats = [
    ...
    { icon: Target, label: "Happy Clients", value: "20+" },
  ]
          ...
          <div>
            <div className="bg-gray-900/50 backdrop-blur-lg border border-cyan-500/20 rounded-xl p-8">
              ...
              <p className="text-gray-300 mb-4">
                I’m Ramesh, a full-stack developer with over 4 years of experience building web apps. I got curious about how websites work, and over time I’ve grown to really enjoy creating smooth, user-friendly experiences.
              </p>
              <p className="text-gray-300 mb-4">
                I mainly work with React.js and modern JavaScript tools, and I love solving tricky problems with creative solutions.
              </p>
              <p className="text-gray-300">
                 When I’m not coding, you’ll find me playing music, gardening, or spending time with animals.
              </p>
            </div>
          </div>
