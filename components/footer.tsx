...
export function Footer() {
  const socialLinks = [
    { icon: Github, href: "https://github.com/007AIMachine", label: "GitHub" },
    { icon: Linkedin, href: "https://www.linkedin.com/in/rameshkumar77/", label: "LinkedIn" },
    { icon: Twitter, href: "#", label: "Twitter" },
    { icon: Mail, href: "mailto:kumar_ramesh@web.de", label: "Email" },
  ]
